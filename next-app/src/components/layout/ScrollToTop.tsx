...
export function ScrollToTop() {
  ...
  return (
    <button
      type="button"
      onClick={scrollToTop}
      className="fixed bottom-6 left-6 z-[999] flex size-10 items-center justify-center rounded-xl border border-white/10 bg-slate-800/80 backdrop-blur-md transition-all duration-300 hover:border-blue-500/50 hover:bg-slate-700/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
